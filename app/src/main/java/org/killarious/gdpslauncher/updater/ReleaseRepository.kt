package org.killarious.gdpslauncher.updater

import org.killarious.gdpslauncher.utils.DownloadUtils.executeCoroutine
...
class ReleaseRepository(private val httpClient: OkHttpClient) {
    ...
    suspend fun getLatestLauncherRelease(): Release? {
        val releasePath = "$GITHUB_API_BASE/repos/killarious/gdps-launcher/releases/latest"
