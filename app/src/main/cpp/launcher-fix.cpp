...
extern "C"
JNIEXPORT void JNICALL Java_org_killarious_gdpslauncher_LauncherFix_setDataPath(
        JNIEnv *env,
        jobject,
        jstring data_path
) {
...
extern "C"
JNIEXPORT void JNICALL Java_org_killarious_gdpslauncher_LauncherFix_setOriginalDataPath(
        JNIEnv *env,
        jobject,
        jstring data_path
) {
